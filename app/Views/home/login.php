                        ...
                        <div class="nk-block nk-block-middle nk-auth-body">
                            <div class="brand-logo pb-5">
                                <a href="html/index.html" class="logo-link">
                                    <img class="logo-light logo-img logo-img-lg" src="<?=base_url('public/images/logo.png');?>" srcset="<?=base_url('public/images/logo.png');?> 2x"  alt="logo">
                                    <img class="logo-dark logo-img logo-img-lg" src="<?=base_url('public/images/logo-dark.png');?>" srcset="<?=base_url('public/images/logo-dark.png');?> 2x" alt="logo-dark">
                                </a>
                            </div>
